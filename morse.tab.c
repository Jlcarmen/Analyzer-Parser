...
{
  "\"end of file\"", "error", "\"invalid token\"", "LETTER", "SPACE",
  "'\\n'", "$accept", "input", "text", YY_NULLPTR
};
...
#line 20 "morse.y"
              { printf("\n"); }
#line 1062 "morse.tab.c"
    break;

  case 3: /* text: text LETTER  */
#line 24 "morse.y"
                { print_morse((yyvsp[0].char_val)); }
#line 1068 "morse.tab.c"
    break;

  case 4: /* text: text SPACE  */
#line 25 "morse.y"
               { printf("/ "); }
#line 1074 "morse.tab.c"
    break;

  case 5: /* text: LETTER  */
#line 26 "morse.y"
           { print_morse((yyvsp[0].char_val)); }
#line 1080 "morse.tab.c"
    break;

  case 6: /* text: SPACE  */
#line 27 "morse.y"
          { printf("/ "); }
#line 1086 "morse.tab.c"
    break;


#line 1090 "morse.tab.c"
